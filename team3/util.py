...
def concat_result(test_unlabel_file, pred_file):
    test_unlabel = pd.read_csv(test_unlabel_file)
    pred = pd.read_csv(pred_file)
    outfile = pd.concat([test_unlabel, pred], axis=1)
    outfile.to_csv(pred_file, index=0, encoding='utf_8')
    print("Saved result to {}".format(pred_file))