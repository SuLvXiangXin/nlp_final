...
def open_process_rewrite(filename):
    ...
    new_filename = "{}_processed{}".format(os.path.basename(path_part), ext_part)
...
if __name__ == '__main__':
    ...
    data_path = args.p
    open_process_rewrite(os.path.join(data_path, 'competition_test_bodies.csv'))
    open_process_rewrite(os.path.join(data_path, 'competition_test_stances_unlabeled.csv'))
    open_process_rewrite(os.path.join(data_path, 'train_bodies.csv'))
    open_process_rewrite(os.path.join(data_path, 'train_stances.csv'))
