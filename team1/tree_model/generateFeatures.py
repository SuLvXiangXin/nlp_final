...
def process(data_path=''):
    ...
    if not read:
        ...
        body_train = pd.read_csv(os.path.join(data_path, "train_bodies_processed.csv"), encoding='utf-8')
        stances_train = pd.read_csv(os.path.join("train_stances_processed.csv"), encoding='utf-8')
        # training set
        ...
        test_flag = True
        if test_flag:
            body_test = pd.read_csv(os.path.join(data_path, "test_bodies_processed.csv"), encoding='utf-8')
            headline_test = pd.read_csv(os.path.join(data_path, "test_stances_unlabeled.csv"), encoding='utf-8')
    ...
    # generators = [tfidfFG, svdFG, word2vecFG, sentiFG]
    # generators = [svdFG, word2vecFG, sentiFG]
    # generators = [word2vecFG, sentiFG]
    # generators = [svdFG]
    # generators = [tfidfFG]
    #generators = [countFG]
    #generators = [walignFG]
