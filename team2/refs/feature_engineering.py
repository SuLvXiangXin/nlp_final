...
from refs.feature_engineering_helper import word_ngrams
from refs.feature_engineering_helper import topic_models
from utils.doc2vec import avg_embedding_similarity
from utils.loadEmbeddings import LoadEmbeddings
from utils.stanford_parser import StanfordMethods
from utils.tf_idf_helpers import tf_idf_helpers
...
def stanford_based_verb_noun_sim(headlines, bodies, bodyIds, headIds, order_sentences=False, num_sents=99):
    def load_embeddings(headlines, bodies):
        ...
        embedding_size = 300
        vocab_size = 3000000
        embeddPath = "../team1/deep_learning_model/GoogleNews-vectors-negative300.bin"
        embeddData = path.normpath(".")
        binary_val = True
